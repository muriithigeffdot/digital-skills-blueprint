            ...
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
                <div className="p-8 sm:p-10">
                    <h1 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: '#1aa22c' }}>
                        <Editable id={`${moduleKey}-title`} defaultText="Module 4: Data Skills for Beginners" />
                    </h1>
                    <p className="text-lg text-gray-700 mb-8">
                        <Editable id={`${moduleKey}-description`} defaultText="A beginner-friendly introduction to data concepts and basic data analysis." />
                    </p>
                    ...
                    <div className="bg-green-50 border-l-4 p-6 rounded-r-lg mb-8" style={{ borderColor: '#1aa22c' }}>
                        ...
                        <p className="text-gray-800">
                            <Editable id={`${moduleKey}-goal`} defaultText="Learners will understand the basics of data, how it's used, and how to perform simple data tasks." />
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center border-t border-gray-200 pt-6 mt-8">
                        ...
                        <Link to="/module5" className="flex items-center px-6 py-3 text-white font-semibold rounded-lg shadow-md hover:opacity-90 transition-opacity duration-300" style={{ backgroundColor: '#1aa22c' }}>
